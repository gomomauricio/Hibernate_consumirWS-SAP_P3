...
*DESCRIPCIÓN: Objeto para almacenar el detalle de envio a webservices SAP
*
...
//	private Integer num_endoso;  //SMALLINT  
	...
	public String toString() {
		return "DetalleEnv [id_transaccion=" + id_transaccion + ", numero_asignacion=" + numero_asignacion
				+ ", concepto=" + concepto + ", lf_importe=" + lf_importe + ", cuenta_l_m=" + cuenta_l_m
				+ ", posicion_presup=" + posicion_presup + ", centro_gestor=" + centro_gestor + ", fondos=" + fondos
				+ ", area_funcional=" + area_funcional + ", centro_coste=" + centro_coste + ", indicador_iva="
				+ indicador_iva + ", segmento=" + segmento + ", clase_contrato=" + clase_contrato + ", lf_moneda="
				+ lf_moneda + ", lf_ramo=" + lf_ramo + ", centro=" + centro + ", acreedor_bp=" + acreedor_bp
				+ ", fecha_base=" + fecha_base + ", clave_condi_pago=" + clave_condi_pago + ", s_uuid=" + s_uuid
				+ ", z_segmento=" + z_segmento + ", z_tipo_reserva=" + z_tipo_reserva + ", z_referencia_cobro="
				+ z_referencia_cobro + ", z_numero_poliza=" + z_numero_poliza + ", z_numero_siniestro="
				+ z_numero_siniestro + ", z_region=" + z_region + ", z_oficina=" + z_oficina + ", z_sistema="
				+ z_sistema + ", z_sucursal=" + z_sucursal + ", z_pais_reasegurador=" + z_pais_reasegurador
				+ ", z_ciclo_cultivo=" + z_ciclo_cultivo + ", z_canal_distrib=" + z_canal_distrib + ", z_producto="
				+ z_producto + ", z_segmento_mercado=" + z_segmento_mercado + ", z_clave_agente=" + z_clave_agente
				+ ", z_numero_salvamento=" + z_numero_salvamento + ", tipo_endoso=" + tipo_endoso + ", gru_rea="
				+ gru_rea + ", ramo_poliza=" + ramo_poliza + ", ramo_puro=" + ramo_puro + ", fisico_moral="
				+ fisico_moral + ", tipo_proveedor=" + tipo_proveedor + ", rfc_proveedor=" + rfc_proveedor
				+ ", nombre_razon_social=" + nombre_razon_social + ", apellido_paterno=" + apellido_paterno
				+ ", apellido_materno=" + apellido_materno + ", name4=" + name4 + ", cuenta_bancaria=" + cuenta_bancaria
				+ ", clave_banco=" + clave_banco + ", pais_banco=" + pais_banco + ", rfc_persona_fisica="
				+ rfc_persona_fisica + ", rfc_persona_moral=" + rfc_persona_moral + ", persona_fisica=" + persona_fisica
